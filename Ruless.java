...
public class Ruless extends JFrame implements ActionListener
{
	...
	Ruless(String name)
	{
		...
		JLabel heading=new JLabel("welcome to " + name + " in Roller Coaster");
		...
		rules.setFont(new Font("Bahnschrift",Font.PLAIN,20));
		rules.setText(
				"<html>"+ 
                "1. Answer the question by selecting following choices." + "<br><br>" +
